        ...
        <div class="card">
                <div class="card-header d-flex justify-content-between text-center">
                    <div class="header-title">
                        <h4 class="card-title">Agregar Actividad</h4>
                    </div>
                </div>
                <div class="card-body">
                <form class="" action="<?php echo base_url();?>index.php/actividad/agregarbd"  autocomplete="off" method="post" onsubmit="return validarFormulario()">
                    ...
                    <div class="field item form-group">
                        ...
                        <div class="col-md-12 col-sm-12">
                        <input class="form-control" class='optional' name="descripcion" autocomplete="off" type="text" required="required"   onblur="validarDescripcion()"/>
                            <span id="errorDescripcion" class="error"></span></div>
                    </div>
                    <div class="field item form-group">
                        <label class="col-form-label   label-align">Hora Inicio de la Actividad: <span class="required">*</span></label>
                        <div class="col-md-12 col-sm-12">
                        <input class="form-control" class='optional' id="carnet" name="horaInicio" autocomplete="off" type="time" required="required"  onblur="validarHoraInicio()"/>
                            <span id="errorHoraInicio" class="error"></span></div>
                    </div>
                    <div class="field item form-group">
                        <label class="col-form-label   label-align">Hora Fin de la Actividad: <span class="required">*</span></label>
                        <div class="col-md-12 col-sm-12">
                        <input class="form-control" class='optional' name="horaFin" autocomplete="off" type="time" required="required"   onblur="validarHoraFin()"/>
                            <span id="errorHoraFin" class="error"></span></div>
                    </div>
                    <div class="field item form-group">
