          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Prestaciones <small></small></h3>
              </div>
            ...
            <div class="clearfix">
                      <div class="row">
                        ...
                        <div class="col-md-3 text-right"><a href="<?php echo base_url(); ?>index.php/prestacion/agregar" class="text-left">
                                <button type="button" class="btn btn-primary">
                                <i class="fa fa-plus"> Nuevo Prestación</i>
                                </button>
                            </a></div>
                      </div>
                    </div>
...
<?php
$indice=1;
foreach($prestacion->result() as $row){
?>
                        <tr>
                          ...
                          <td>
                          <?php
                            echo form_open_multipart('prestacion/modificar');
                            ?>
                            <input type="hidden" name="id" value="<?php echo $row->id; ?>">

                            <button type="submit" class="btn btn-small btn-success"><i class="icon">
                          ...
                          <td>
                            <?php
                            echo form_open_multipart('prestacion/eliminarbd');
                            ?>
                            <input type="hidden" name="id" value="<?php echo $row->id; ?>">

                            <button type="submit" class="btn btn-small btn-danger"><i class="icon">
                            <svg class="icon-24" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
