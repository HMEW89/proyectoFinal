            ...
            <div class="">
                <div class="card-header d-flex justify-content-between text-center">
                    <div class="header-title">
                        <h2 class="card-title">Nueva Prestación</h2>
                    </div>
                </div>
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <h5>Detalle de la Prestación</h5>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12"><br>
                                            ...
                                            <h5>Servicios Agregados a la Prestación</h5>
                                            <hr>
                                                ...
                                                <table class="table table-hover table-bordered" id="tabla" name="tabla">
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td >
                                                            <input type="text" id="total" name="total" value="0" style="border: none; outline: none; width: 50px;">
                                                            </td>
        ...
        $('#btn-agregar').on('click', function() {
            ...
            if (nombreSer !== '' && observacion !== '' && fecha !== '') {
                ...
                var nuevaFila = '<tr>' +
                    ...
                    "<td><input type='hidden' name='costo[]' value='" + costoSeleccionado + "'>" + costoSeleccionado + "</td>" +
                    "<td><input type='hidden' name='cantidad[]' value='" + cantidad + "'>" + cantidad + "</td>" +
                    "<td><input type='hidden' name='importe[]' value='" + importe(costoSeleccionado, cantidad)  + "'>" + importe(costoSeleccionado, cantidad) + "</td>" +
