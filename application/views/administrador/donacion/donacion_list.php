          ...
          <div class="">
            ...
            <div class="clearfix">
                      <div class="row">
                        ...
                        <div class="col-md-3 text-right"><a href="<?php echo base_url(); ?>index.php/miembro/agregar" class="text-left">
...
?>
                        <tr>
                          ...
                          <td>
                          <?php
                            echo form_open_multipart('miembro/modificar');
                            ?>
                          ...
                          <td>
                            <?php
                            echo form_open_multipart('miembro/eliminarbd');
                            ?>
                            <input type="hidden" name="id" value="<?php echo $row->id; ?>">
