          ...
          <div class="">
            <div class="page-title">
              <div class="title_left"><br>
                <h3>Lista de Eventos <small></small></h3>
              </div>
            ...
            <div class="clearfix">
                      <div class="row">
                        ...
                        <div class="col-md-3 text-right"><a href="<?php echo base_url(); ?>index.php/evento/agregar" class="text-left">
...
?>
                        <tr>
                          ...
                          <td><?php echo $row->fechaHoraInicio; ?></td>
                          <td><?php echo $row->fechaHoraFin; ?></td>
                          <td>
                          <?php
                            echo form_open_multipart('evento/modificar');
                            ?>
                          ...
                          <td>
                            <?php
                            echo form_open_multipart('evento/eliminarbd');
                            ?>
                            <input type="hidden" name="id" value="<?php echo $row->id; ?>">
