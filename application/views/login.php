                  ...
                  <div class="col-md-10">
                     <div class="card card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <div class="card-body ">
                           ...
                           <img src="<?php echo base_url();?>img/logo.png" alt="CentroCatólico" width="30%;">
                            <img src="<?php echo base_url();?>img/nombrelogo.png" alt="CentroCatólico" width="60%;"><br><br>
                           
                           <h2 class="mb-2 text-center">INICIAR SESIÓN</h2><br> 
                           <?php
...
?>
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <input type="text" required autocomplete="off" class="form-control" id="nombreUsuario" name="nombreUsuario" placeholder=" ">
        </div>
        </div>
        <div class="col-lg-12">
        <div class="form-group">
            <label for="password" class="form-label">Contraseña</label>
            <input type="password" class="form-control" id="password" name="contrasenia"  required autocomplete="off">
        </div>
        </div>
        <div class="col-lg-12 d-flex justify-content-between">
        <a href="recoverpw.html">¿Haz olvidado tu contraseña?</a>
        </div>
    </div><br><br>
...
?>
            ...
            <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
               <img src="<?php echo base_url();?>img/altar4.jpg" class="img-fluid gradient-main animated-scaleX" alt="images">
            </div>
         </div>
      </section>
      </div>
